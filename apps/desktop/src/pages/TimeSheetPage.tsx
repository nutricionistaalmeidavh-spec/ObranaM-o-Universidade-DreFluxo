...
export default function TimeSheetPage(){
  ...
  return <>
    ...
    {batchOpen&&<Card className="print-batch-card" style={{marginBottom:14,maxWidth:620,marginLeft:'auto'}}>
      ...
      <div className="row-actions" style={{justifyContent:'flex-end',flexWrap:'wrap'}}><Button variant="secondary" onClick={()=>setBatchOpen(false)} disabled={busy}>Cancelar</Button><Button variant="secondary" icon={<FileDown size={15}/>} onClick={generateAll} disabled={busy}>Somente gerar</Button><Button variant="secondary" icon={<RotateCcw size={15}/>} onClick={reprintAll} disabled={busy||(!printPoint&&!printReceipts)}>Reimprimir</Button><Button icon={<Printer size={15}/>} onClick={printAll} disabled={busy||(!printPoint&&!printReceipts)}>Imprimir</Button></div>
    </Card>}
