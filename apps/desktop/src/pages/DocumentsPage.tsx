...
export default function DocumentsPage() {
  ...
  return <>
    ...
    {view === 'pastas' ? <FileExplorer rootId="documents" rootLabel="Documentos" title="Pastas de documentos" description="Navegue pela estrutura física gerenciada pelo Fluxo DRE. Nesta etapa, nenhuma ação desta visualização altera arquivos ou pastas."/> : <>
